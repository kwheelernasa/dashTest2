run_app:
	...
	find pages_files -exec sed -i.bak 's|_dash-component-suites|dashTest2\\/_dash-component-suites|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-layout|dashTest2/_dash-layout.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-dependencies|dashTest2/_dash-dependencies.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_reload-hash|dashTest2/_reload-hash|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-update-component|dashTest2/_dash-update-component|g' {} \;
	find pages_files -exec sed -i.bak 's|assets|dashTest2/assets|g' {} \;
